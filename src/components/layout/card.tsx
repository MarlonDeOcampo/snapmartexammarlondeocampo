        ...
        <div className="overflow-auto relative mt-14">
            <div className="h-[80vh] grid grid-cols-cards justify-around gap-y-4">
                {items && items.map((item) => (
                    <div key={item.id} className="relative p-5 m-1 cursor-pointer border border-[#F5F5F5] w-[14rem] h-[22rem] text-gray-600 flex flex-col justify-between shadow-lg">
                        ...
                        <button className="bg-secondary hover:bg-primary w-full py-2 text-white text-sm">Add to Cart</button>
                    </div>
                ))}
            </div>
        </div >
